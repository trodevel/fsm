...
void init_fsm_2( fsm::Process * fsm )
{
    ...
    fsm->create_set_next_action_connector( PLAYING_MESSAGE_1__PlayFailed__ac1, new fsm::Exit() );
    ...
    fsm->create_set_next_action_connector( PLAYING_MESSAGE_1__Cancel__ac1, new fsm::Exit() );
    ...
    fsm->create_set_next_action_connector( PLAYING_MESSAGE_1__ConnectionLost__ac1, new fsm::Exit() );
    ...
    fsm->create_set_next_action_connector( PLAYING_MESSAGE_2__PlayFailed__ac1, new fsm::Exit() );
    ...
    fsm->create_set_next_action_connector( PLAYING_MESSAGE_2__Cancel__ac1, new fsm::Exit() );
    ...
    fsm->create_set_next_action_connector( PLAYING_MESSAGE_2__ConnectionLost__ac1, new fsm::Exit() );
    ...
    fsm->create_set_alt_next_action_connector( WAITING_ACTION__TONE__ac3, new fsm::NextState( WAITING_ACTION ) );
    auto WAITING_ACTION__TONE__ac4      = fsm->create_set_next_action_connector( WAITING_ACTION__TONE__ac3, new fsm::SendSignal( "ScenPlayMessage", { fsm::ExpressionPtr( new fsm::ExpressionVariable( action_message ) )} ));
